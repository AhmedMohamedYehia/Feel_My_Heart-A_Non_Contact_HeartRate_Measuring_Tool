...
# # First module (ROI to RGB channels)
...
def plotICA(Matrix,Sources):
    ...
    for i in range (len(Sources[0])):
        x_list.append(i+1)
#     plt.subplot(1, 2, 1)
#     plt.plot(x_list,Matrix[0], 'r')
#     plt.xlabel('num of frames')
#     plt.ylabel('brightness')
#     plt.title('Detrended Normalized Red channel')
#     print(detrended_normalized_red)
#     plt.subplot(1, 2, 2)
...
#     print("PWT after function",PWT)
#     print("CM after function",CM)
    V=JointDiagonalization(Matrix,CM)
#     print("V",V)
    B=arranging_norming(B,V)
    #B is demixing matrix
...
#     x_list=[]
#     for i in range (len(lowPass0)):
#         x_list.append(i+1)
#     plt.subplot(1, 2, 1)
#     plt.plot(x_list, Sources[0],'r')
#     plt.xlabel('num of frames')
#     plt.ylabel('amplitude')
#     plt.title('first independent source')
#     plt.subplot(1, 2, 2)
#     plt.plot(x_list, lowPass0)
#     plt.xlabel('num of frames')
#     plt.ylabel('amplitude')
#     plt.title('low pass first independent source')
#     plt.tight_layout()
#     plt.show()

#     ################################################################
#     plt.subplot(1, 2, 1)
#     plt.plot(x_list, Sources[1],'r')
#     plt.xlabel('num of frames')
#     plt.ylabel('amplitude')
#     plt.title('first independent source')

#     plt.subplot(1, 2, 2)
#     plt.plot(x_list, lowPass1)
#     plt.xlabel('num of frames')
#     plt.ylabel('amplitude')
#     plt.title('low pass second independent source')
#     plt.tight_layout()
#     plt.show()

#     ################################################################
#     plt.subplot(1, 2, 1)
#     plt.plot(x_list, Sources[2],'r')
#     plt.xlabel('num of frames')
#     plt.ylabel('amplitude')
#     plt.title('first independent source')

#     plt.subplot(1, 2, 2)
#     plt.plot(x_list, lowPass2)
#     plt.xlabel('num of frames')
#     plt.ylabel('amplitude')
#     plt.title('low pass third independent source')
#     plt.tight_layout()
#     plt.show()
...
#     plt.subplot(1, 2, 2)
#     plt.plot(x_list, bandPass0,'r')
#     plt.xlabel('num of frames')
#     plt.ylabel('amplitude')
#     plt.title('band pass first independent source')
...
#     plt.subplot(1, 2, 2)
#     plt.plot(x_list, bandPass1,'r')
#     plt.xlabel('num of frames')
#     plt.ylabel('amplitude')
#     plt.title('band pass second independent source')
#     plt.tight_layout()
#     plt.show()
...
#     plt.subplot(1, 2, 2)
#     plt.plot(x_list, bandPass2,'r')
#     plt.xlabel('num of frames')
#     plt.ylabel('amplitude')
#     plt.title('band pass third independent source')
#     plt.tight_layout()
